...
class PosesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pose" do
    assert_difference('Pose.count') do
      post poses_url, params: { pose: { demo_icon_url: @pose.demo_icon_url, english_name: @pose.english_name, sanskrit_name: @pose.sanskrit_name } }
    end
  ...
  test "should update pose" do
    patch pose_url(@pose), params: { pose: { demo_icon_url: @pose.demo_icon_url, english_name: @pose.english_name, sanskrit_name: @pose.sanskrit_name } }
